...
public class DataStatisticsDaoImpl extends BaseDao implements DataStatisticsDao{
	...
	@Override
	public List<DataStatisticsModel> getOnline(String id, Date startTime, Date endTime) {
		// TODO Auto-generated method stub
		Map<String,Object> hashMap = new HashMap<String,Object>();
		hashMap.put("starttime", startTime);
		hashMap.put("endtime",endTime);
		...
		List<DataStatisticsModel> dataStatisticsModels = (List<DataStatisticsModel>) this.getSqlMapClientTemplate().queryForList("getOnline",hashMap);
