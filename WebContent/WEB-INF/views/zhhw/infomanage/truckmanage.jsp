...
<body style="background: #f0f9fd;">
	...
	<div class="rightinfo">
		...
		<div>
			<fmt:message key="truck.id" />:<input  type="text"style="width: 170px; height: 30px;"
			id="truck_id" class="easyui-textbox" data-options="required:true" />
			<fmt:message key="truck.plateno" />:<i></i><input type="text"
			id="truck_pla" style="width: 170px; height: 30px;" class="easyui-textbox"data-options="required:false" />
			<fmt:message key="truck.starttime" />:<input
			type="text" style="width: 170px; height: 30px;" class="easyui-datebox"
			id="truck_st" data-options="required:false,multiline:true" />
			<fmt:message key="truck.endtime" />:<i></i><input
			id="truck_et" type="text" style="width: 170px; height: 30px;" class="easyui-datebox"
			data-options="required:false,multiline:true" /><i></i><i></i><i></i>
			<fmt:message key="truck.comname" />:<input type="text"style="width: 170px; height: 30px;" class="easyui-combobox"
			name="fk_org_id" id="truck_org" id="org" data-options="required:true" />
			<fmt:message key="truck.length" />&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
			 type="text" style="width: 170px; height: 30px;" class="easyui-textbox"
			id="truck_len" data-options="required:false,multiline:true" /><i></i><i></i><i></i>
			<fmt:message key="truck.width" />&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
			 type="text" style="width: 170px; height: 30px;" class="easyui-textbox"
			id="truck_wid" data-options="required:false,multiline:true" />
			<fmt:message key="truck.weight" />:<input
			 type="text" style="width: 170px; height: 30px;" class="easyui-textbox"
			id="truck_wei" data-options="required:false,multiline:true" /><i></i>
			<fmt:message key="truck.color" />： <input
			type="text" style="width: 170px; height: 30px;" class="easyui-textbox"
			id="truck_col" data-options="required:false,multiline:true" />
			<fmt:message key="truck.vin" /> :    <input
			type="text" style="width: 170px; height: 30px;" class="easyui-textbox"
			id="truck_vin" data-options="required:false,multiline:true" />
			<fmt:message key="truck.online" />： <input
			type="text" style="width: 170px; height: 30px;" class="easyui-textbox"
			id="truck_onl" data-options="required:false,multiline:true" />
			<fmt:message key="truck.city" /> :    <input
			 type="text" style="width: 170px; height: 30px;" class="easyui-textbox"
			id="truck_city" data-options="required:false,multiline:true" />
			<fmt:message key="truck.province" /> :    <input
			type="text" style="width: 170px; height: 30px;" class="easyui-textbox"
			id="truck_pro" data-options="required:false,multiline:true" />
			<fmt:message key="truck.version" />:<i></i><i></i><input
		 	type="text" style="width: 170px; height: 30px;" class="easyui-textbox"
			id="truck_ver" data-options="required:false,multiline:true" />
			...
			id="truck_device" data-options="required:false,multiline:true" />
			<fmt:message key="truck.sim" /> :<input
			id="truck_sim"  type="text" style="width: 170px; height: 30px;" class="easyui-textbox"
			data-options="required:false,multiline:true" />
			<fmt:message key="truck.remark" /> :    <input
			id="truck_rem" type="text" style="width: 170px; height: 30px;" class="easyui-textbox"
			data-options="required:false,multiline:true" />
		</div>
