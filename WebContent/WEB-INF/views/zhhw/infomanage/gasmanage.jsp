...
<body style="background: #f0f9fd;">
	...
	<div class="rightinfo">
		...
		<div>
			<fmt:message key="gas.id" /><input name="id" type="text"
				style="width: 200px; height: 30px;" " class="easyui-textbox"
				id="gas_id" data-options="required:true" />
			<fmt:message key="gas.plateno" />:<input name="fk_car_id" type="text"
				style="width: 200px; height: 30px;" " class="easyui-combobox" 
				id="gas_car" data-options="required:true" />
			<fmt:message key="gas.type" />:<input name="type" type="text"
				style="width: 200px; height: 30px;" " class="easyui-textbox"
				id="gas_type" data-options="required:false" />
			<fmt:message key="gas.volume" />： <input
				name="volume" type="text" style="width: 200px; height: 30px;" class="easyui-textbox"
				id="gas_vol" data-options="required:false,multiline:true" /><i></i>
			<fmt:message key="gas.money" />： <input
				name="money" type="text" style="width: 200px; height: 30px;" class="easyui-textbox"
				id="gas_money" data-options="required:false,multiline:true" />
			<fmt:message key="gas.price" />： <input
				name="price" type="text" style="width: 200px; height: 30px;" class="easyui-textbox"
				id="gas_price" data-options="required:false,multiline:true" />
			<fmt:message key="gas.coordinate" />： <input
				name="coordinate" type="text" style="width: 200px; height: 30px;" class="easyui-textbox"
				id="gas_coor" data-options="required:false,multiline:true" />
			<fmt:message key="gas.driver" />： <input
				name="fk_driver_id" type="text" style="width: 200px; height: 30px;" class="easyui-combobox"
				id="gas_driver" data-options="required:false,multiline:true" />>
			<fmt:message key="gas.user" />： <input
				name="fk_handman" type="text" style="width: 200px; height: 30px;" class="easyui-textbox"
				id="gas_fkh" data-options="required:false,multiline:true" />
			<fmt:message key="gas.create" />： <input
				name="createtime" type="text" style="width: 200px; height: 30px;" class="easyui-datebox"
