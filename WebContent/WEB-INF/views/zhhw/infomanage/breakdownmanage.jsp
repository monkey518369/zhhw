...
<body style="background: #f0f9fd;">
	...
	<div class="rightinfo">
		...
		<div>
			<fmt:message key="hitch.id" /><input type="text"
					style="width: 200px; height: 30px;" " class="easyui-textbox"
					id="hitch_id" data-options="required:true"/>
			<fmt:message key="hitch.plateno" />:</label><input name="fk_truck_id" type="text"
					style="width: 200px; height: 30px;" " class="easyui-combobox",
					id="hitch_car" data-options="required:true,url:'${ctx}/combobox/getGasPlateList',
					valueField:'id', textField:'plate_no'"/>
			<fmt:message key="hitch.describe" />:<input type="text"
					style="width: 200px; height: 30px;" " class="easyui-textbox"
					id="hitch_des" data-options="required:false" /><i>
			<fmt:message key="hitch.lng" />： <input
					name="lng" type="text" style="width: 200px; height: 30px;" class="easyui-numberbox"
					id="hitch_lng" data-options="required:false,multiline:true" />
			<fmt:message key="hitch.lat" />： <input
					name="lat" type="text" style="width: 200px; height: 30px;" class="easyui-numberbox"
					id="hitch_lat" data-options="required:false,multiline:true"/></br>
			<fmt:message key="hitch.starttime" />： <input
			 type="text" style="width: 200px; height: 30px;" class="easyui-datebox"
			...
			<fmt:message key="hitch.user" />： <input
					name="user_id" type="text" style="width: 200px; height: 30px;" class="easyui-numberbox"
					id="hitch_uid" data-options="required:false,multiline:true" />
		</div>
