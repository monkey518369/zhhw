...
<title>里程统计</title>
<link rel="stylesheet" type="text/css" href="../js/datastatistics/mileage.css">
<%@ include file="/include/jquery.libs.jsp"%>
<script type="text/javascript" src="../js/highchart/highcharts.js"></script>
<script type="text/javascript" src="../js/datastatistics/mileage.js"></script>
</head>
<body class="easyui-layout">
<div data-options="region:'north',split:false" class="mileage_north">
	<div class="place">
		<span>位置：</span>
		<ul class="placeul">
			<li><a href="${ctx}/center">首页</a></li>
			<li><a href="javascript:void(0)">统计报表</a></li>
			<li><a href="javascript:void(0)">里程统计</a></li>
		</ul>
	</div>
</div>
<div data-options="region:'west',split:true,title:'选项'" class="mileage_west">
	<div class="west_top" data-options="region:'north'">
		<div class="mileage_type">
			<input id="radio_org_time" type="radio" name="mileage_type" value="group_time"/>组织统计
		</div>
		<div class="mileage_type">
			<input id="radio_org" type="radio" name="mileage_type" value="group"/>组织对比
		</div>
		<div class="mileage_type">
			<input id="radio_car" type="radio" name="mileage_type" value="car"/>多车对比
		</div>
		<div class="mileage_type">
			<input id="radio_time" type="radio" name="mileage_type" value="time"/>单车统计
		</div>
	</div>
...
<div data-options="region:'center',split:true" class="mileage_center">
...
<div id="org_window_org_time" class="easyui-window" title="组织树" left="250px" style="width:300px;height:400px"
			data-options="modal:true,closed:true">
		    <div class="easyui-panel" title="菜单" data-options="tools: [{iconCls:'icon-save',handler:saveorgtime}]"
		    		style="height:99%;">
...
<div id="car_window" class="easyui-window" title="组织树" left="600px" style="width:300px;height:400px"
			data-options="modal:true,closed:true">
		    <div id="car_window_child" class="easyui-panel" title="菜单" data-options="tools: [{    
		    iconCls:'icon-cancel',handler:cancelcar},{iconCls:'icon-save',    
		    handler:savecar}]" style="width:94%;">
				<ul id="car_tree" ></ul>
			</div>	
</div>
<!-- 右键菜单 -->
