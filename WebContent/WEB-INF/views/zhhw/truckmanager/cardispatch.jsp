...
<html>
  ...
  <body>
	<div id="layout" class="easyui-layout" style="width:100%;height:580px;">   
       <div data-options="region:'north',split:false,title:'车辆选择'" split="false" collapsible='false' style="height:380px;overflow:auto;">
       		<div style="float:left;height:380px;width:22%;overflow:auto;">
       			<ul id="orgTree"></ul> 
       		</div>
       		<div style="float:left;overflow:auto;height:380px;width:22%;">
       			<ul id="carTree"></ul>
       		</div>
       		<div style="float:left;overflow:auto;width:56%;height:380px">
       			<table id='carChecked' class="easyui-datagrid" style="width:100%;height:355px"   
       ...
       <div data-options="region:'center',title:'调度方式设置'" split="false" style="height:200px;overflow:auto;">
