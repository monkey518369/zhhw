...
<html>
  <head>
	...
	<style>
		/*选项卡1*/  
		#toolCarDynamic,#toolCarfindInArea{width:500px;margin:0px;padding:0px;margin-bottom:15px; overflow:hidden;}  
  ...
  <body class="easyui-layout" style="text-align:left">
  	...
  	<!-- 显示组织树 -->
  	<div id="orgWin" class="easyui-window" collapsible='false' closed="true" minimizable='false' maximizable='false' title="选择组织机构" style="width:300px;height:500px;padding:5px;">
  		组织机构：
  	...
  	<!-- 车辆动态信息工具栏 -->
	<div id="toolCarDynamic" class="lib_tabborder_sx" style="background-color: #ffffff; position: absolute; left: 120px; top: 30px; z-index: 1000; display: none;">
		...
		<div class="lib_Contentbox_sx ">
			<div id="con_one_1">
				...
				&nbsp;&nbsp;&nbsp;<input type="radio" name="searchType" onclick ="orgShow();">选择车辆:<input id="carlist" class="easyui-combobox" name="dept" /> <a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="searchByPlateNo('plate_no_fk_org');"></a>
    ...
    <div region="west" collapsible="false" split="false" icon="icon-info" title="管理项" style="width:120px;" class="big-size-icon">
	...
	<div data-options="region:'center',plain:true,title:'车辆位置信息'"
		style="overflow: hidden; height: 100%; width: 100%" id="opt_info">
		<div class="easyui-layout" style="width: 90%; height: 90%">
			<div id="mapdata" class="easyui-layout" style="width: 100%; height: 100%">
				<div data-options="region:'center',title:'地图',split:true" id="map"
